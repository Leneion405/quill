import MaxWidthWrapper from '@/component/MaxWidthWarper'
...
const Page = async () => {
  ...
  // Check if PLANS is defined and is an array
  const proPlan = Array.isArray(PLANS) ? PLANS.find((p) => p.slug === 'pro') : null
  ...
  const pricingItems = [
    ...
    },
    {
      ...
      quota: proPlan?.quota || 0,  // Use the found plan's quota or default to 0
      features: [
        {
